...
def test_challenger_snippet_score_gate():
    ...
    assert "outcomes.real_strat_ret_45d" in snippet, "Should use the correct metric"
...
def test_challenger_snippet_metric_and_guardrails():
    ...
    assert "outcomes.real_strat_ret_45d" in snippet, "Should use opt_ret_45d metric"
